...
- Text styling, including changing the [color](/en-US/docs/Web/CSS/Reference/Values/color) and [size](/en-US/docs/Web/CSS/Reference/Properties/font-size) of headings and links.
