...
The {{cssxref("overflow")}} property allows you to specify how the browser should handle overflowing content. The default value of the [`<overflow>`](/en-US/docs/Web/CSS/Reference/Values/overflow) value type is `visible`. With this default setting, one can see content when it overflows.
