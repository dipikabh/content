...
- Added support for specifying colors with an alpha channel using 4- and 8-digit CSS hex [color](/en-US/docs/Web/CSS/Reference/Values/color) values (#RRGGBBAA and #RGBA) ([Firefox bug 567283](https://bugzil.la/567283)).
