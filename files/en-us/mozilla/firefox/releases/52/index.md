...
- Implemented interpolation between numeric color and [`currentColor`](/en-US/docs/Web/CSS/Reference/Values/color#currentcolor_keyword) ([Firefox bug 1299741](https://bugzil.la/1299741)).
...
- Removed `-moz-use-text-color` value from color properties; use [`currentColor`](/en-US/docs/Web/CSS/Reference/Values/color#currentcolor_keyword) instead ([Firefox bug 1306214](https://bugzil.la/1306214)).
