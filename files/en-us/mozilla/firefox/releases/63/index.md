...
- Re-enabled support for [webkit-prefixed pixel-density @media queries](/en-US/docs/Web/CSS/Reference/Vendor_prefixed/WebKit/-webkit-device-pixel-ratio) ([Firefox bug 1444139](https://bugzil.la/1444139)).
