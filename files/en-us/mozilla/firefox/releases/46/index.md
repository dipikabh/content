...
- Added support for [`@media (-webkit-transform-3d)`](/en-US/docs/Web/CSS/Reference/Vendor_prefixed/WebKit/-webkit-transform-3d) as a media query for 3D transform support, if about:config pref `layout.css.prefixes.webkit` is set to `true` ([Firefox bug 1239799](https://bugzil.la/1239799)).
