...
- CSS color functions `color()`, `lab()`, `lch()`, `oklab()`, and `oklch()` are now supported.
  ...
  For more information, see the [CSS color value](/en-US/docs/Web/CSS/Reference/Values/color) documentation ([Firefox bug 1352757](https://bugzil.la/1352757) and [Firefox bug 1128204](https://bugzil.la/1128204)).
