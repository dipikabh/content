...
Color wheels are convenient for comparing colors expressed in polar or cylindrical coordinates, like [`hsl()`](/en-US/docs/Web/CSS/Reference/Values/color/hsl), [`hwb()`](/en-US/docs/Web/CSS/Reference/Values/color/hwb), or [`lch()`](/en-US/docs/Web/CSS/Reference/Values/color/lch).
...
- [`<color>`](/en-US/docs/Web/CSS/Reference/Values/color) the CSS data type
