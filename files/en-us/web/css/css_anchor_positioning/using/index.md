...
> [!NOTE]
> See the [`<position-area>`](/en-US/docs/Web/CSS/Reference/Values/position-area) value reference page for a detailed description of all the available values. Mixing a logical value with a physical value will invalidate the declaration.
