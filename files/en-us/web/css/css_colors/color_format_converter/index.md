...
This tool lets you enter or pick a color and copy its corresponding value in any CSS [color format](/en-US/docs/Web/CSS/Reference/Values/color). You can use the generated color value anywhere the {{cssxref("color", "&lt;color&gt;")}} data type is supported in CSS. This tool can also help you understand the syntax of the different color notations.
