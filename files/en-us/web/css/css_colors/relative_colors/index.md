...
1. Include a basic color function (represented by _`color-function()`_ above) such as [`rgb()`](/en-US/docs/Web/CSS/Reference/Values/color/rgb), [`hsl()`](/en-US/docs/Web/CSS/Reference/Values/color/hsl), etc. Which one you pick depends on the color model you want to use for the relative color you are creating (the **output color**).
...
3. In the case of the [`color()`](/en-US/docs/Web/CSS/Reference/Values/color/color) function, include the _[`colorspace`](/en-US/docs/Web/CSS/Reference/Values/color/color#colorspace)_ of the output color.
4. Provide an output value for each individual channel. The output color is defined after the origin color — represented above by the _`channel1`_, _`channel2`_, and _`channel3`_ placeholders. The channels defined here depend on the [color function](/en-US/docs/Web/CSS/CSS_colors#functions) you are using for your relative color. For example, if you are using [`hsl()`](/en-US/docs/Web/CSS/Reference/Values/color/hsl), you would need to define the values for hue, saturation, and lightness. Each channel value can be a new value, the same as the original value, or a value relative to the channel value of the origin color.
...
>
> - Older sRGB color functions cannot express the full spectrum of visible colors. The output colors of ([`hsl()`](/en-US/docs/Web/CSS/Reference/Values/color/hsl), [`hwb()`](/en-US/docs/Web/CSS/Reference/Values/color/hwb), and [`rgb()`](/en-US/docs/Web/CSS/Reference/Values/color/rgb)) are serialized to `color(srgb)` to avoid these limitations. That means that querying the output color value via the {{domxref("HTMLElement.style")}} property or the {{domxref("CSSStyleDeclaration.getPropertyValue()")}} method returns the output color as a [`color(srgb ...)`](/en-US/docs/Web/CSS/Reference/Values/color/color) value.
> - For more recent color functions (`lab()`, `oklab()`, `lch()`, and `oklch()`), relative color output values are expressed in the same syntax as the color function used. For example, if a [`lab()`](/en-US/docs/Web/CSS/Reference/Values/color/lab) color function is being used, the output color will be a `lab()` value.
...
In the section above we only saw relative colors defined via the [`rgb()`](/en-US/docs/Web/CSS/Reference/Values/color/rgb) function. However, relative colors can be defined using any modern CSS color function — [`color()`](/en-US/docs/Web/CSS/Reference/Values/color/color), [`hsl()`](/en-US/docs/Web/CSS/Reference/Values/color/hsl), [`hwb()`](/en-US/docs/Web/CSS/Reference/Values/color/hwb), [`lab()`](/en-US/docs/Web/CSS/Reference/Values/color/lab), [`lch()`](/en-US/docs/Web/CSS/Reference/Values/color/lch), [`oklab()`](/en-US/docs/Web/CSS/Reference/Values/color/oklab), [`oklch()`](/en-US/docs/Web/CSS/Reference/Values/color/oklch), or [`rgb()`](/en-US/docs/Web/CSS/Reference/Values/color/rgb). The general syntax structure is the same in each case, although the origin color values have different names appropriate for the function being used.
...
> [!NOTE]
> You can find additional examples demonstrating the use of relative color syntax in the different functional notation types on their dedicated pages: [`color()`](/en-US/docs/Web/CSS/Reference/Values/color/color#using_relative_colors_with_color), [`hsl()`](/en-US/docs/Web/CSS/Reference/Values/color/hsl#using_relative_colors_with_hsl), [`hwb()`](/en-US/docs/Web/CSS/Reference/Values/color/hwb#using_relative_colors_with_hwb), [`lab()`](/en-US/docs/Web/CSS/Reference/Values/color/lab#using_relative_colors_with_lab), [`lch()`](/en-US/docs/Web/CSS/Reference/Values/color/lch#using_relative_colors_with_lch), [`oklab()`](/en-US/docs/Web/CSS/Reference/Values/color/oklab#using_relative_colors_with_oklab), [`oklch()`](/en-US/docs/Web/CSS/Reference/Values/color/oklch#using_relative_colors_with_oklch), [`rgb()`](/en-US/docs/Web/CSS/Reference/Values/color/rgb#using_relative_colors_with_rgb).
...
The colors themselves include the `--base-color`, plus relative colors derived from that `--base-color`. The relative colors use the [`lch()`](/en-US/docs/Web/CSS/Reference/Values/color/lch) function — passing in the origin `--base-color` and defining an output color with an adjusted lightness or hue channel as appropriate.
...
In the CSS the `:root` has a default `--hue` value set on it, relative [`lch()`](/en-US/docs/Web/CSS/Reference/Values/color/lch) colors to define the color scheme, plus a radial gradient that fills the whole body.
