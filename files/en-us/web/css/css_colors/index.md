...
The color syntax converter below shows the values of the currently selected color in [red-green-blue](/en-US/docs/Web/CSS/Reference/Values/color/rgb) (RGB), [hexadecimal](/en-US/docs/Web/CSS/Reference/Values/hex-color) (HEX), [hue, saturation, and lightness](/en-US/docs/Web/CSS/Reference/Values/color/hsl) (HSL), and [hue, whiteness, and blackness](/en-US/docs/Web/CSS/Reference/Values/color/hwb) (HWB) CSS color formats. All the RGB, HEX, HSL, and HWB color values here, while written differently, represent the same color value.
...
- Color functions:
  - [`rgb()`](/en-US/docs/Web/CSS/Reference/Values/color/rgb)
  - [`hsl()`](/en-US/docs/Web/CSS/Reference/Values/color/hsl)
  - [`hwb()`](/en-US/docs/Web/CSS/Reference/Values/color/hwb)
  - [`lab()`](/en-US/docs/Web/CSS/Reference/Values/color/lab)
  - [`lch()`](/en-US/docs/Web/CSS/Reference/Values/color/lch)
  - [`oklab()`](/en-US/docs/Web/CSS/Reference/Values/color/oklab)
  - [`oklch()`](/en-US/docs/Web/CSS/Reference/Values/color/oklch)
...
- [`<colorspace-params>`](/en-US/docs/Web/CSS/Reference/Values/color/color#using_predefined_color_spaces_with_color)

### Glossary terms and keywords

- {{glossary("Color space")}}
- [`currentColor`](/en-US/docs/Web/CSS/Reference/Values/color#currentcolor_keyword)
...
- [Color format converter](/en-US/docs/Web/CSS/CSS_colors/Color_format_converter)
  - : A tool that lets you enter or pick a color and copy its corresponding value in any CSS [color format](/en-US/docs/Web/CSS/Reference/Values/color).
