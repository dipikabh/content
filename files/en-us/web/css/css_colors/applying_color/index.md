...
To learn more about CSS colors as a data type, see the [CSS `<color>` data type](/en-US/docs/Web/CSS/Reference/Values/color) reference and the [CSS color values guide](/en-US/docs/Web/CSS/CSS_colors/Color_values).
...
- {{cssxref("text-decoration-color")}}
  - : The default text decorations (such as underlines, strikethroughs, etc.) color is [`currentColor`](/en-US/docs/Web/CSS/Reference/Values/color#currentcolor_keyword). This keyword represents the current value of the `color` property. However, you can override that value and use a different color for them with the `text-decoration-color` property.
