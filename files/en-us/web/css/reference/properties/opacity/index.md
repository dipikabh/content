...
To change the opacity of a background only, use the {{cssxref("background")}} property with a [color value](/en-US/docs/Web/CSS/Reference/Values/color) that allows for an alpha channel. For example:
