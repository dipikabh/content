...
Alternatively, use the [`light-dark()`](/en-US/docs/Web/CSS/Reference/Values/color/light-dark) [`<color>` function](/en-US/docs/Web/CSS/Reference/Values/Functions#color_functions) to set the foreground and background colors for the different color schemes using a more compact code structure:
