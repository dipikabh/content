...
The marker will be [`currentColor`](/en-US/docs/Web/CSS/Reference/Values/color#currentcolor_keyword), the same as the computed [color](/en-US/docs/Web/CSS/Reference/Values/color) of the element it applies to.
