...
A `<system-color>` value can be used anywhere a [`<color>`](/en-US/docs/Web/CSS/Reference/Values/color) can be used.
...
- [`<color>`](/en-US/docs/Web/CSS/Reference/Values/color): the data type these keywords belong to
