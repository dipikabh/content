...
The four sides of each `<div>` have a different `<line-style>` value, and each list item has a different {{cssxref("color", "&lt;color>")}} value. We use [generated content](/en-US/docs/Web/CSS/Reference/Properties/content) to display the CSS declared inline.
