---
title: hsl()
slug: Web/CSS/Reference/Values/color/hsl
...
- [`lch()`](/en-US/docs/Web/CSS/Reference/Values/color/lch) and [`hwb()`](/en-US/docs/Web/CSS/Reference/Values/color/hwb) color functions
- [Hue interpolation in `color-mix()`](/en-US/docs/Web/CSS/Reference/Values/color/color-mix#using_hue_interpolation_in_color-mix)
- [List of all color notations](/en-US/docs/Web/CSS/Reference/Values/color)
