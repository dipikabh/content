...
A `<hex-color>` value can be used everywhere where a [`<color>`](/en-US/docs/Web/CSS/Reference/Values/color) can be used.
...
- [`rgb()`](/en-US/docs/Web/CSS/Reference/Values/color/rgb) color function
