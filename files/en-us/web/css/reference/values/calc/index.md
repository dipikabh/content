...
In the paragraphs that follow, `calc()` is used with the [`rgb()`](/en-US/docs/Web/CSS/Reference/Values/color/rgb) and [`hsl()`](/en-US/docs/Web/CSS/Reference/Values/color/hsl) functions to adjust the values of each color channel relative to the original named color.
