...
slug: Web/CSS/Reference/Vendor_prefixed/WebKit/-webkit-animation
...
The **`-webkit-animation`** Boolean [CSS](/en-US/docs/Web/CSS) [media feature](/en-US/docs/Web/CSS/@media#media_features) is a [WebKit extension](/en-US/docs/Web/CSS/Reference/Vendor_prefixed/WebKit) whose value is `true` if vendor-prefixed CSS {{cssxref("animation")}}s are supported.
