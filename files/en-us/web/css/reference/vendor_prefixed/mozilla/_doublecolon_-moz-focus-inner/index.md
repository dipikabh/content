...
slug: Web/CSS/Reference/Vendor_prefixed/Mozilla/::-moz-focus-inner
...
The **`::-moz-focus-inner`** [CSS](/en-US/docs/Web/CSS) [pseudo-element](/en-US/docs/Web/CSS/Pseudo-elements) is a [Mozilla extension](/en-US/docs/Web/CSS/Reference/Vendor_prefixed/Mozilla) that represents an inner focus ring of the {{HTMLElement("button")}} element as well as the {{HTMLElement("input/button","button")}}, {{HTMLElement("input/submit","submit")}}, {{HTMLElement("input/reset","reset")}}, and {{HTMLElement("input/color","color")}} types of the {{HTMLElement("input")}} element.
...
- Related CSS properties:
  - [`-moz-user-focus`](/en-US/docs/Web/CSS/Reference/Vendor_prefixed/Mozilla/-moz-user-focus)
