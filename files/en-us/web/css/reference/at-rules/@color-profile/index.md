...
The **`@color-profile`** [CSS](/en-US/docs/Web/CSS) [at-rule](/en-US/docs/Web/CSS/CSS_syntax/At-rules) defines and names a color profile which can later be used in the {{cssxref("color/color", "color()")}} function to specify a color.
