...
In addition, even for the styles mentioned above, transparency differences between unvisited and visited links are not applied. This restriction prevents the use of the `alpha` parameter in various {{cssxref("color", "&lt;color&gt;")}} functions or the [`transparent`](/en-US/docs/Web/CSS/Reference/Values/named-color#transparent) keyword to distinguish between the two states.
