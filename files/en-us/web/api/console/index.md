...
> [!NOTE]
> In order to support both light and dark color schemes, {{cssxref("color/light-dark")}} can be used when specifying colors; for example: `color: light-dark(#D00000, #FF4040);`
