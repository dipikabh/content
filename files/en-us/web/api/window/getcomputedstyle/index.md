...
For compatibility reasons, serialized color values specified using the traditional sRGB color space are expressed as [`rgb()`](/en-US/docs/Web/CSS/Reference/Values/color/rgb) colors if the alpha channel value is exactly `1`, and `rgba()` colors otherwise.
The legacy syntax with commas is used, with commas as separators (for example `rgb(255, 0, 0)`).

For other {{glossary("color space","color spaces")}} the values are serialized using the corresponding functional expressions: [`lab()`](/en-US/docs/Web/CSS/Reference/Values/color/lab), [`lch()`](/en-US/docs/Web/CSS/Reference/Values/color/lch) [`oklab()`](/en-US/docs/Web/CSS/Reference/Values/color/oklab), [`oklch()`](/en-US/docs/Web/CSS/Reference/Values/color/oklch), [`color()`](/en-US/docs/Web/CSS/Reference/Values/color/color).
